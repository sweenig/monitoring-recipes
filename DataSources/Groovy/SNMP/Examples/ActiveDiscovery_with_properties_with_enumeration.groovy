...
propstoget = [
  ...
  ******************************************************************************/
  ...
  /*******************************************************************************
    An alternative of the MTU property could look like this. In this case, if the value of .4.##WILDVALUE## were to contain 1500, the property would
    contain the enumerated string instead of "1500". If it were to contain any other value, it would simply contain that value. The next property (5)
    is another example of only replacing certain values with enumerated strings.
  ******************************************************************************/
  ...
  ******************************************************************************/
  ...
  /*******************************************************************************
   ...
   The returned values are then stored as properties with the names "ifAdminStatus" and "ifOperStatus". One advantage to storing ifAdminStatus as an enumerated string is that you could group instances
   based on administrative status where the groups would be named "Up", "Down", and "Testing" respectively.
  ******************************************************************************/
